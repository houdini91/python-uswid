...
class uSwidGlobalMap(IntEnum):
    ...
    UNSPSC_CODE = 56
    UNSPSC_VERSION = 57
    # from AbstractJsonOutputHandler.java in swid-tools
    FIRMWARE_FIELD = 59
    # from CBORFirmwareOutputHandler.java in swid-tools
    FIRMWARE_MANIFEST_ID_FIELD = 63  # bytes / text / uint
    FIRMWARE_MANIFEST_CREATION_TIMESTAMP = 64  # time
    FIRMWARE_MANIFEST_VERSION = 65  # uint
    FIRMWARE_MANIFEST_DESCRIPTION = 66  # text
    FIRMWARE_MANIFEST_NONCE = 67  # bytes
    FIRMWARE_MANIFEST_DEPENDENCIES = 68  # resource-reference
    FIRMWARE_MANIFEST_ALIASES = 69  # resource-reference
    FIRMWARE_MANIFEST_TARGET_DEVICE_ID = 85  # object firmware-payload
    FIRMWARE_MANIFEST_PAYLOAD_ENTRY = 60
    FIRMWARE_PAYLOAD_ID = 61  # bytes / text / uint
    FIRMWARE_PAYLOAD_PACKAGE_ID = 62  # text
    FIRMWARE_PAYLOAD_DESCRIPTION = 70  # text
    FIRMWARE_PAYLOAD_FORMAT = 71  # object
    FIRMWARE_PAYLOAD_FORMAT_TYPE = 72  # int
    FIRMWARE_PAYLOAD_FORMAT_GUIDANCE = 73  # bytes
    FIRMWARE_PAYLOAD_SIZE = 74  # unint
    FIRMWARE_PAYLOAD_PACKAGE = 75  # object
    FIRMWARE_PAYLOAD_PACKAGE_COMPRESSION_TYPE = 76  # text / int
    FIRMWARE_PAYLOAD_PACKAGE_COMPRESSION_GUIDANCE = 77  # bytes
    FIRMWARE_PAYLOAD_PACKAGE_VALUE = 78  # bytes
    FIRMWARE_PAYLOAD_TARGET_COMPONENT_INDEX = 79  # text
    FIRMWARE_PAYLOAD_STORAGE_IDENTIFIER = 80  # bytes / text / uint
    FIRMWARE_PAYLOAD_TARGET_DEPENDENCY = 81  # array of objects
    FIRMWARE_PAYLOAD_RELATIONSHIPS = 84  # enum (int)
    FIRMWARE_TARGET_DEVICE_IDENTIFIER_VENDOR = 86  # text
    FIRMWARE_TARGET_DEVICE_IDENTIFIER_TYPE = 87  # text
    FIRMWARE_TARGET_DEVICE_IDENTIFIER_MODEL = 88  # text
    FIRMWARE_TARGET_DEVICE_IDENTIFIER_CLASS = 89  # text
    FIRMWARE_TARGET_DEVICE_IDENTIFIER_RFC4122 = 90  # text
    FIRMWARE_TARGET_DEVICE_IDENTIFIER_IEEE802_1_AR = 91  # bytes
    FIRMWARE_PAYLOAD_TARGET_MINIMAL_VERSION = 92  # object
    FIRMWARE_PAYLOAD_DIGESTS = 97  # object
    FIRMWARE_PAYLOAD_DIGEST_TYPE = 98  # enum (int)
    FIRMWARE_PAYLOAD_DIGEST_GUIDANCE = 99  # bytes
    FIRMWARE_PAYLOAD_DIGEST_VALUE = 100  # bytes
    FIRMWARE_PAYLOAD_CONDITIONS = 101  # array of objects
    FIRMWARE_PAYLOAD_DIRECTIVES = 104  # array of objects
    FIRMWARE_PAYLOAD_SIMPLE_VERSION = 107  # uint
    FIRMWARE_PAYLOAD_VERSION = 108  # object
    FIRMWARE_MANIFEST_SIMPLE_EXTENSIONS = 115  # { + int => bytes }
    FIRMWARE_PAYLOAD_SIMPLE_EXTENSIONS = 116  # { + int => bytes }
